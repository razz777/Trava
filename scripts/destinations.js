const cities = [
  ...
  },
  {
    ...
    timezone: "GST",
    description:
      "Bhubanswar is the capital city of the Odisha, featuring magnificent architecture, pristine beaches, and a thriving cultural scene.",
    price: 9740,
  },
];
...
function displayCity(city) {
  ...
  addToWishlist.addEventListener("click", () => {
    ...
    let isAlreadyInCart = userLogin.cart.some(item => item.name === city.name);
    if (!isAlreadyInCart) {
